        ...
        configureServer(server) {
            ...
            return () => server.middlewares.use((req, res, next) => {
                if (req.url === '/index.html') {
                    server.config.logger.warn("\n" + picocolors_1.default.bgYellow(picocolors_1.default.black(`The Vite server should not be accessed directly. Your Laravel application's configured APP_URL is: ${appUrl}`)));
                    res.statusCode = 404;
