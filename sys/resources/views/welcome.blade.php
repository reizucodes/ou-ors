                ...
                <div class="relative flex items-top justify-center min-h-screensm:items-center py-4 sm:pt-0">
                    @if (Route::has('login'))
                        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                            @auth
                                <a href="{{ url('/home') }}" class="text-sm text-gray-700 dark:text-gray-500 " style="">Dashboard</a>
                            @else
                    ...
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                            ...
                            <img src="img/ORS UI.png" style="width:100%">
                            <div class="text">Caption Three</div>
                            </div>
                            
                        <div class="mySlides fade">
                        <div class="numbertext">2 / 3</div>
                        <img src="img/BUOU ORS UI.png" style="width:100%">
                        <div class="text">Caption Three</div>
                        </div>
